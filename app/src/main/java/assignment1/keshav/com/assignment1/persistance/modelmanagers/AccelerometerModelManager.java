 ...
 */
public class AccelerometerModelManager extends SensorModelManager
{
    ...
    public AccelerometerModelManager(SQLiteDatabase db)
    {
        super(db);
    ...
    public List retrieveData()
    {
        ...
        {
            vals.add("x: " + res.getFloat(res.getColumnIndex(AccelerometerEntry.AXIS_X)) +
                    "y: " + res.getFloat(res.getColumnIndex(AccelerometerEntry.AXIS_Y))   +
                    "z: " + res.getFloat(res.getColumnIndex(AccelerometerEntry.AXIS_Z) )
    ...
    public LineData retrieveChartData()
    {
        ...
        stb.append("SELECT * FROM ")
                .append(AccelerometerEntry.TABLE_NAME)
                .append(" ORDER BY " + AccelerometerEntry.TIME_TAKEN + " DESC ")
                .append(LIMIT);
        ...
        while(res.moveToNext())
        {
            ...
            // Add entries
            xEntries.add(new Entry(res.getFloat(res.getColumnIndex(AccelerometerEntry.AXIS_X)), count));
            yEntries.add(new Entry(res.getFloat(res.getColumnIndex(AccelerometerEntry.AXIS_Y)), count));
            zEntries.add(new Entry(res.getFloat(res.getColumnIndex(AccelerometerEntry.AXIS_Z)), count));
